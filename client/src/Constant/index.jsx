...
export const Earning = "Production";
...
export const MonthlyProfitsTitle = "Product Order";
...
export const TestRequestTittle = "Test Request List";
...
export const OrderOverviewTitle = "Summary Actual";
export const Refunds = "Shipping";
