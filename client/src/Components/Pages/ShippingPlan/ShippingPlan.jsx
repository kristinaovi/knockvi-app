...
import ShippingPlanList from './ShippingPlanList';
import NewShippingPlan from './NewShippingPlan';
import UploadShippingPlan from './UploadShippingPlan';
...
const ShippingPlan = () => {
  ...
  return (
    <Fragment>
      <Breadcrumbs parent="Shipping Plan" mainTitle="Shipping Plan" />
      ...
      <UploadShippingPlan isOpen={uploadModalOpen} toggle={toggleUploadModal} />
      <NewShippingPlan isOpen={modalOpen} toggle={toggleModal} />
      </Container>
    </Fragment>
  );
};
