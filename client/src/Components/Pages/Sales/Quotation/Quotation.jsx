...
const Quotation = () => {
  ...
  return (
    <Fragment>
      <Breadcrumbs parent="Sales" title="Quotation" mainTitle="Quotation" />
      ...
      <UploadQuotation isOpen={uploadModalOpen} toggle={toggleUploadModal} />
      <NewQuotation isOpen={modalOpen} toggle={toggleModal} />
      </Container>
    </Fragment>
  );
};
